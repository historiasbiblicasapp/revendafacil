...
export default function FinanceiroPage() {
  ...
  const cards = [
    { title: 'Entradas', value: data?.entradas || 0, icon: TrendingUp, color: 'text-violet-600', bg: 'bg-violet-100' },
    { title: 'Saídas', value: -(data?.saidas || 0), icon: TrendingDown, color: 'text-rose-600', bg: 'bg-rose-100' },
    { title: 'Lucro Bruto', value: data?.lucroBruto || 0, icon: DollarSign, color: 'text-purple-600', bg: 'bg-purple-100' },
    { title: 'Lucro Líquido', value: data?.lucroLiquido ?? 0, icon: PiggyBank, color: 'text-fuchsia-600', bg: 'bg-fuchsia-100' },
    { title: 'Saldo Atual', value: data?.saldoAtual ?? 0, icon: Wallet, color: 'text-indigo-600', bg: 'bg-indigo-100' },
    { title: 'A Receber', value: data?.totalPendente || 0, icon: TrendingUp, color: 'text-amber-600', bg: 'bg-amber-100' },
  ]
